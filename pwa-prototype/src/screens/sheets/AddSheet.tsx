...
const OPTIONS: Option[] = [
  { id: 'build', icon: 'fork', label: 'Build a meal', sub: 'Combine several foods', flow: { kind: 'mealBuilder' } },
  { id: 'search', icon: 'search', label: 'Search food', sub: 'Saved foods & full catalog', flow: { kind: 'search' } },
  { id: 'scan', icon: 'barcode', label: 'Scan barcode', sub: 'Point your camera at a product', flow: { kind: 'scan' } },
  { id: 'manual', icon: 'pencil', label: 'Manual entry', sub: 'Type the macros yourself', flow: { kind: 'manual' } },
  { id: 'quick', icon: 'sparkles', label: 'Quick add', sub: 'Describe a meal in plain text', flow: { kind: 'quickAdd' } },
  { id: 'photo', icon: 'camera', label: 'Photo meal', sub: 'Snap a plate, AI logs it', flow: { kind: 'photoMeal' } },
]
